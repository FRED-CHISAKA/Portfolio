...
<div class="page-wrapper">
     ...
     <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="resume-summary-edit.php" class="btn btn btn-primary btn-rounded float-right"><i class="bi bi-printer"></i> Edit Objective</a>
            </div>
        </div>
     </div>
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="education-add.php" class="btn btn-primary btn-sm">
                        ...
                        <tbody>
                            <?php while ($edu = mysqli_fetch_assoc($education)) { ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="education-edit.php?id=<?= $edu['id'] ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <a href="education-delete.php?id=<?= $edu['id'] ?>"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="experience-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Experience
            </a>
        </div>
                        ...
                        <tbody>
                            <?php while ($exp = mysqli_fetch_assoc($experience)) { ?>
                                <tr>
                                    ...
                                    <td class="text-end">
                                        <a href="experience-edit.php?id=<?= $exp['id'] ?>"
                                            class="btn btn-sm btn-outline-primary"
                                        >
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <a href="experience-delete.php?id=<?= $exp['id'] ?>"
                                            class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="skill-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Skill
            </a>
        </div>
                        ...
                        <div class="col-md-6 col-lg-4">
                            <div class="border rounded p-3 h-100">
                                <div class="d-flex justify-content-between align-items-start">
                                    ...
                                    <div>
                                        <a href="skill-edit.php?id=<?= $skill['id'] ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <a href="skill-delete.php?id=<?= $skill['id'] ?>"
                                            class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="certification-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Certification
            </a>
        </div>
                            ...
                            <?php while ($cert = mysqli_fetch_assoc($certifications)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="certification-delete.php?id=<?= $cert['id'] ?>"
                                            class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="language-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Language
            </a>
        </div>
                        ...
                        <div class="col-md-6">
                            <div class="border rounded p-3">
                                <div class="d-flex justify-content-between">
                                    ...
                                    <div>
                                        <a href="language-edit.php?id=<?= $language['id'] ?>" class="btn btn-sm btn-outline-primary">
                                            <i class="bi bi-pencil"></i>
                                        </a>

                                        <a href="language-delete.php?id=<?= $language['id'] ?>"
                                            class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="interest-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Interest
            </a>
        </div>
                    ...
                    <?php while ($interest = mysqli_fetch_assoc($interests)) { ?>
                        <div class="col-md-4 col-lg-3">
                            <div class="border rounded p-3 text-center">
                                ...
                                <div>
                                    <a href="interest-edit.php?id=<?= $interest['id'] ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil"></i>
                                    </a>

                                    <a href="interest-delete.php?id=<?= $interest['id'] ?>"
                                        class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="award-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Achievement
            </a>
        </div>
                            ...
                            <?php while ($award = mysqli_fetch_assoc($awards)) { ?>
                                <tr>
                                    ...
                                    <td>
                                        ...
                                        <a href="award-delete.php?id=<?= $award['id'] ?>"
                                            class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0 mb-4">
        <div class="card-header bg-white py-3 d-flex justify-content-between align-items-center">
            ...
            <a href="referee-add.php" class="btn btn-primary btn-sm">
                <i class="bi bi-plus-lg me-1"></i>
                Add Referee
            </a>
        </div>
                    ...
                    <?php while ($ref = mysqli_fetch_assoc($referees)) { ?>
                        <div class="col-md-6">
                            <div class="border rounded p-4 h-100">
                                ...
                                <div>
                                    <a href="referee-edit.php?id=<?= $ref['id'] ?>" class="btn btn-sm btn-outline-primary">
                                        <i class="bi bi-pencil me-1"></i>
                                        Edit
                                    </a>

                                    <a href="referee-delete.php?id=<?= $ref['id'] ?>"
                                        class="btn btn-sm btn-outline-danger"
    ...
    <div class="card shadow-sm border-0">
        <div class="card-body p-4">
            <div class="d-flex justify-content-between align-items-center">
                ...
                <a href="../resume.php" target="_blank" class="btn btn-outline-primary">
