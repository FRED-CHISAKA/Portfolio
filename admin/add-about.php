            ...
            <form action="about-store.php" method="POST">
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-12">
                        ...
                        <textarea id="slogan" name="slogan" class="form-control" rows="4"
                            placeholder="Write your professional introduction..."></textarea>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="city" name="city" class="form-control" placeholder="e.g. Kakamega">
                    </div>
                </div>
                ...
                <div class="row g-3 mb-4">
                    ...
                    <div class="col-md-6">
                        ...
                        <input type="text" id="certification" name="certification"
                            class="form-control" placeholder="e.g. Huawei, PowerDMARC..."
                        >
                    </div>
                </div>
