<?php
    ...
    $sql = "SELECT * FROM certifications ORDER BY issue_date DESC, id DESC";

    $result = mysqli_query($conn, $sql);

    // Count certifications
    $total_sql = "SELECT COUNT(*) AS total FROM certifications";
    ...
    $active_sql = "SELECT COUNT(*) AS total FROM certifications WHERE status = 1";
    ...
    $hidden_sql = "SELECT COUNT(*) AS total FROM certifications WHERE status = 0";
    ...
    <div class="content">
        <div class="row">
            ...
            <div class="col-sm-8 col-9 text-right m-b-20">
                <a href="certification-add.php" class="btn btn btn-primary btn-rounded float-right"><i class="fa fa-plus"></i> Add Certification</a>
            </div>
        </div>
    </div>
        ...
        <div class="card-body p-0">
            ...
            <?php } else { ?>
                ...
                <div class="text-center py-5">
                    ...
                    <a href="certification-add.php" class="btn btn-primary">
