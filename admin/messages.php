                                    ...
                                    <a href="activities.html">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Chisaka Fred</span> added new task <span class="noti-title">Patient appointment booking</span></p>
                                                            ...
                                                            <div class="chat-content img-content">
                                                                <div class="chat-img-group clearfix">
                                                                    ...
                                                                    <a class="chat-img-attach" href="#">
                                                                        <img width="182" height="137" alt="" src="../assets/img/service-1.png">
                                                                    ...
                                                                    <a class="chat-img-attach" href="#">
                                                                        <img width="182" height="137" alt="" src="../assets/img/service-2.jpg">
                                                                        <div class="chat-placeholder">
                                                                            <div class="chat-img-name">842 KB</div>
                                                                        </div>
                                                                    </a>
                                                                    <a class="chat-img-attach" href="#">
                                                                        <img width="182" height="137" alt="" src="../assets/img/service-3.jpg">
                                                                        <div class="chat-placeholder">
                                                                            <div class="chat-img-name">placeholder.jpg</div>
                                                                            <div class="chat-file-desc">842 KB</div>
                                                                        </div>
                                            ...
                                            <div class="chats">
                                                ...
                                                <div class="chat chat-left">
                                                    ...
                                                    <div class="chat-body">
                                                        <div class="chat-bubble">
                                                            <div class="chat-content">
                                                                <span class="chat-user">Joy Ashley</span> <span class="chat-time">8:35 am</span>
                                                                <div class="call-details">
                                                ...
                                                <div class="table-content">
                                                    ...
                                                    <div class="chat-profile-info">
                                                        <ul class="user-det-list">
                                                            <li>
                                                                <span>Username:</span>
                                                                <span class="float-right text-muted">@chisaka_TechDive</span>
                                                            </li>
                                                            <li>
                                                                <span>DOB:</span>
                                                            ...
                                                            <li>
                                                                <span>Email:</span>
                                                                <span class="float-right text-muted">chisaka@techdive.com</span>
                                                            </li>
                                                            <li>
                                                                <span>Phone:</span>
                                                                <span class="float-right text-muted"> +2541 1447 8336</span>
                                                            </li>
                                                        </ul>
                                                    </div>
                                                                    ...
                                                                    <li>
                                                                        <div class="files-cont">
                                                                            ...
                                                                            <div class="files-info">
                                                                                <span class="file-name text-ellipsis">Smart Farming Project Documentation.xls</span>
                                                                                <span class="file-author"><a href="#">Chisaka Fred</a></span> <span class="file-date">May 31st at 6:53 PM</span>
                                                                            </div>
                                                                ...
                                                                <ul class="files-list">
                                                                    <li>
                                                                        <div class="files-cont">
                                                                            ...
                                                                            <div class="files-info">
                                                                                <span class="file-name text-ellipsis">User-Care Cloud Infrastructure Plan.xls</span>
                                                                                <span class="file-author"><a href="#">Kevin White</a></span> <span class="file-date">May 31st at 6:53 PM</span>
                                                                            </div>
                                                                            <ul class="files-action">
                                                                                <li class="dropdown dropdown-action">
                                                                                    <a href="#" class="dropdown-toggle" data-toggle="dropdown" aria-expanded="false"><i class="fa fa-ellipsis-h"></i></a>
                                        ...
                                        <a href="#">
                                            <div class="media">
												<span class="avatar align-self-center">
													<img src="assets/img/user.jpg" alt="Chisaka Fred">
												</span>
												<div class="media-body text-nowrap align-self-center">
													<div class="user-name">Chisaka Fred</div>
