        ...
        <div class="header">
			<div class="header-left">
				<a href="index.php" class="logo">
					<img src="assets/img/icon.jpg" width="35" height="35" alt="" style="border-radius: 50% !important;"> <span>Chisaka Fred</span>
				</a>
			</div>
                                    ...
                                    <a href="activities.php">
                                        <div class="media">
											...
											<div class="media-body">
												<p class="noti-details"><span class="noti-title">Contacts</span> Update <span class="noti-title">New contact form submitted</span></p>
